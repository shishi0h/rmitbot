...
#define ENC3_A 34// Pin used on ESP32 for the ENC3_A
#define ENC3_B 35// Pin used on ESP32 for the ENC3_B
#define ENC4_A 17// Pin used on ESP32 for the ENC4_A
...
#define MOT2_B 17 // Pin used on ESP32 for the MOT2_B
#define MOT3_A 26 // Pin used on ESP32 for the MOT3_A
#define MOT3_B 25 // Pin used on ESP32 for the MOT3_B
#define MOT4_A 16 // Pin used on ESP32 for the MOT4_A
