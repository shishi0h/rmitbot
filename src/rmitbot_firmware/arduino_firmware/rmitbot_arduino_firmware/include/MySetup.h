...
#define ENC2_A 23 // Pin used on ESP32 for the ENC2_A
#define ENC2_B 19 // Pin used on ESP32 for the ENC2_B
#define ENC3_A 35 // Pin used on ESP32 for the ENC3_A
#define ENC3_B 34 // Pin used on ESP32 for the ENC3_B
#define ENC4_A 27 // Pin used on ESP32 for the ENC4_A
#define ENC4_B 14 // Pin used on ESP32 for the ENC4_B
...
#define MOT4_A 4  // Pin used on ESP32 for the MOT4_A
#define MOT4_B 13 // Pin used on ESP32 for the MOT4_B
