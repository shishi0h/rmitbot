...
def generate_launch_description():
    ...
    map_merge_node = Node(
        ...
        parameters=[
            {"use_sim_time": False},
            {"robot0_topic": "/robot_1/map"},
            {"robot1_topic": "/robot_2/map"},
            {"merged_topic": "/map"}
        ]
    )
    ...
    global_costmap_merge_node = Node(
        ...
        parameters=[
            {"use_sim_time": False},
            {"robot0_topic": "/robot_1/global_costmap/costmap"},
            {"robot1_topic": "/robot_2/global_costmap/costmap"},
    ...
    local_costmap_merge_node = Node(
        ...
        parameters=[
            {"use_sim_time": False},
            {"robot0_topic": "/robot_1/local_costmap/costmap"},
            {"robot1_topic": "/robot_2/local_costmap/costmap"},
